    ...
    <Card className="min-w-0 overflow-hidden">
      <CardHeader className="min-w-0">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <Badge variant="violet">Live progress</Badge>
        </div>
      </CardHeader>
      <CardContent className="min-w-0 space-y-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm text-white/70">
                    {celebrationId === "launch-ready"
                      ...
                      : "A real onboarding win was captured and the next recommended action was updated automatically."}
                  </p>
                </div>
              </div>
        ...
        {analytics.activeNudge ? (
          <div className="rounded-[24px] border border-amber-300/20 bg-amber-300/10 p-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div className="min-w-0">
                <p className="text-sm font-medium text-white">Helpful reminder</p>
        ...
        <div className={summaryGridClassName}>
          <div className="min-w-0 rounded-2xl border border-white/8 bg-white/[0.03] p-4">
            ...
            <p className="mt-2 text-xs text-white/42">
              Activity captured from {analytics.trackedOperatorCount || 0} of {analytics.workspaceMemberCount || 0} teammate{analytics.workspaceMemberCount === 1 ? "" : "s"}.
            </p>
          </div>
